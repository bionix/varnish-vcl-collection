...
include "/etc/varnish/dh-vcl-zdt/lib/xforward.vcl";
include "/etc/varnish/dh-vcl-zdt/lib/cloudflare.vcl";
include "/etc/varnish/dh-vcl-zdt/lib/purge.vcl";
include "/etc/varnish/dh-vcl-zdt/lib/bigfiles.vcl";        # Varnish 3.0.3+
#include "lib/bigfiles_pipe.vcl";  # Varnish 3.0.2
include "/etc/varnish/dh-vcl-zdt/lib/static.vcl";
